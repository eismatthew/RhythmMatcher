...
var a = {
  ...
  notes: [
    ...
    { duration: 3.33, delay: 1.55 }, //3
    // { duration: 3.33, delay: 3.1}, //5
    // { duration: 3.33, delay: 4.65 }, //7
    { duration: 3.33, delay: 6.2}, //9
    { duration: 3.33, delay: 7.75 }, //13
    { duration: 3.33, delay: 9.3 }, //17
    { duration: 3.33, delay: 10.85}, //21
    { duration: 3.33, delay: 12.4}, //25
     { duration: 3.33, delay: 0 + two_bar }, //1
    { duration: 3.33, delay: 1.55 + two_bar  }, //3
    { duration: 3.33, delay: 3.1 + two_bar }, //5
    { duration: 3.33, delay: 4.65 + two_bar  }, //7
    { duration: 3.33, delay: 6.2 + two_bar }, //9
    // { duration: 3.33, delay: 7.75 + two_bar  }, //13
    // { duration: 3.33, delay: 9.3 + two_bar  }, //17
    // { duration: 3.33, delay: 10.85 + two_bar }, //21
    { duration: 3.33, delay: 12.4 + two_bar }, //25
...
var s = {
  ...
  notes: [
    ...
    { duration: 3.33, delay: 6.2 + two_beat + two_bar }, //11
    { duration: 3.33, delay: 7.75 + two_beat + two_bar  }, //15
...
var k = {
  ...
  notes: [
    ...
    // { duration: 3.33, delay: 0  + two_beat + two_bar }, //2
...
var l = {
  ...
  notes: [
    ...
    { duration: 3.33, delay: 10.85 + two_bar}, 
  ]
};
